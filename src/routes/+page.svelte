<script lang="ts">
    ...
    {label: "---"},{label: "GSoC 2020"},  {label: "---"}, {label: "Projects"},{label: "Alumni Summit"}, {label: "Demo Day"},
    {label: "---"},{label: "GSoC 2019"},  {label: "---"}, {label: "Projects"},{label: "Alumni Summit"}, {label: "Demo Day"},
    {label: "---"},{label: "GSoC 2018"},  {label: "---"}, {label: "Projects"},{label: "Alumni Summit"}, {label: "Demo Day"},
    {label: "---"},{label: "GSoC 2017"},  {label: "---"}, {label: "Projects"},{label: "Alumni Summit"}, {label: "Demo Day"},
],},
{ top: "AI Club", dropdown: [ {label: "Weekly meetup"},  {label: "---"},{label: "Open Channel"}, {label: "Discussion Forum"}, {label: "Discord"},],},
];

    // Herounit data from CRM
    let herotitle = "Welcome to our <b style='color:red'>community</b>";
    let herosub = "Let's dream, share, and collaborate in shaping the future of the Rocket.Chat ecosystem together !!";

    // Docslink data from CRM
    let leftlink = "Read the Guides";
    let rightlink = "Read Release Notes";

    // Searchbar data from CRM
    let searchactions = { placeholder: "Find commmunity information",
    ...
    let counters = [ { max: 388388, label: "Users"}, {max: 12828288, label: "Messages"}, {max: 802, label: "Online"}];

    // SimonLinktiles data from CRM
    let tilelinks = [[{ title: "Documentation", desc: "Find in-depth information about Rocket.Chat features and API."},
	...
	let stories = [
		...
		},
		{
			...
			description: 'In Series A funding confirming privacy-first communication as a major trend in 2021',
    ...
    let caption = "Get What You Need...";
    let personas = ["Admin", "Developer", "Group chat", "GSoC"];
    let images =  [  
