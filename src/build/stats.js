export const data = {
	statistics: [
			...
			os: {
				...
				cpus: [
					...
					},
					{
						model: 'Intel(R) Xeon(R) CPU E5-2686 v4 @ 2.30GHz',
						speed: 2300,
						times: { user: 14463450, nice: 7140, sys: 2307120, idle: 3164610000, irq: 0 }
					}
				]
			},
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3195325.333623481 },
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3713725.307644639 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
				...
				cpus: [
					{
						model: 'Intel(R) Xeon(R) CPU E5-2686 v4 @ 2.30GHz',
						speed: 2300,
						times: { user: 7822000, nice: 4500, sys: 1297980, idle: 1795572820, irq: 0 }
					},
					{
						model: 'Intel(R) Xeon(R) CPU E5-2686 v4 @ 2.30GHz',
						speed: 2300,
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1812925.314926702 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
				...
				cpus: [
					{
						model: 'Intel(R) Xeon(R) CPU E5-2686 v4 @ 2.30GHz',
						speed: 2300,
						times: { user: 12486000, nice: 5850, sys: 2038600, idle: 2821987010, irq: 0 }
					},
					{
						model: 'Intel(R) Xeon(R) CPU E5-2686 v4 @ 2.30GHz',
						speed: 2300,
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2849725.339901139 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2158525.325020757 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
			...
			os: {
				...
				cpus: [
					...
					},
					{
						model: 'Intel(R) Xeon(R) CPU E5-2686 v4 @ 2.30GHz',
						speed: 2300,
						times: { user: 6595190, nice: 4340, sys: 1082470, idle: 1453519000, irq: 0 }
					}
				]
			},
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1467325.308622105 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3540925.316386503 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3972925.327943801 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2676925.325777787 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2331325.331330325 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1294525.308293806 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3022525.338672134 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3368125.315638011 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1640125.31863003 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3620137.821628465 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3886525.319299709 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1985725.332806561 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2072125.310387528 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2244925.309630695 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1035325.326697377 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2590525.320845641 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2417725.321151546 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1208125.332559714 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2763325.357469127 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2936125.346113775 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1380925.300181282 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3108925.341226202 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3281725.336846782 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1553725.309161267 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3454525.313373366 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
			...
			os: {
				...
				cpus: [
					...
					},
					{
						model: 'Intel(R) Xeon(R) CPU E5-2686 v4 @ 2.30GHz',
						speed: 2300,
						times: { user: 3083390, nice: 3000, sys: 526160, idle: 683411010, irq: 0 }
					}
				]
			},
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3619880.090010598 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1726525.301713447 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3627325.30417518 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 3800125.313041934 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1899325.341767418 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 1121725.317954719 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
		...
		},
		{
			...
			process: { nodeVersion: 'v14.21.3', pid: 1, uptime: 2504125.37138199 },
			deploy: { method: 'docker', platform: 'selfinstall' },
			readReceiptsEnabled: false,
			readReceiptsDetailed: false,
			enterpriseReady: true,
